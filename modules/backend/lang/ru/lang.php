...
return [
    ...
    'user' => [
        ...
        'group' => [
            ...
            'code_field' => 'Код',
            'code_comment' => 'Чтобы получить доступ с API, необходимо ввести уникальный код.',
            'menu_label' => 'Группы',
    ...
    'list' => [
        ...
        'delete_selected_empty' => 'Не выделены записи, чтобы удалять.',
        'delete_selected_confirm' => 'Действительно удалить выбранные записи?',
    ...
    'relation' => [
		'missing_config' => "Поведение отношения не имеет никакую конфигурацию для ':config'.",
		...
		'link_selected' => "Связать выбранные",
        'link_a_new' => "Связывание новой :name",
        'cancel' => "Отмена",
		'close' => "Закрыть",
		...
		'link' => "Ссылка",
        'link_name' => "Ссылка :name",
        'unlink' => "Удалить ссылку",
        'unlink_name' => "Удалить ссылку :name",
